...
def backup_existing_data(backup_dir):
    ...
    backup_items = [
        ...
        "storage/documents",
        "storage/pdfs",
        "storage/pdf_thumbnails",
        "storage/document_ids.json"
    ]
...
def import_data(import_source, backup=True, verify=True):
    ...
    import_map = {
        "database": ("storage/documents.db", "storage/documents.db", "file"),
        "chroma_db": ("storage/chroma_db", "storage/chroma_db", "directory"),
        "documents": ("storage/documents", "storage/documents", "directory"),
        "pdfs": ("storage/pdfs", "storage/pdfs", "directory"),
        "pdf_thumbnails": ("storage/pdf_thumbnails", "storage/pdf_thumbnails", "directory"),
        "document_ids": ("storage/document_ids.json", "storage/document_ids.json", "file"),
    }
    ...
    # Check database
    if os.path.exists("storage/documents.db"):
