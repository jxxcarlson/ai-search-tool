...
var $author$project$Main$NewDocument = F3(
	function (title, content, docType) {
		return {content: content, docType: docType, title: title};
	});
var $author$project$Models$Document = F6(
	function (id, title, content, createdAt, docType, index) {
		return {content: content, createdAt: createdAt, docType: docType, id: id, index: index, title: title};
	});
...
var $author$project$Models$documentDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Models$Document,
...
var $author$project$Main$EditingDocument = F4(
...
var $author$project$Models$encodeDocument = F3(
	function (title, content, docType) {
...
var $author$project$Api$addDocument = F5(
	function (config, title, content, docType, msg) {
...
var $author$project$Models$SearchResult = F7(
...
var $author$project$Models$searchResultDecoder = A8(
	...
	$author$project$Models$SearchResult,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string),
	$elm$json$Json$Decode$maybe(
...
var $author$project$Models$encodeUpdate = F3(
	function (title, content, docType) {
		var fields = A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
...
var $author$project$Api$updateDocument = F6(
	function (config, docId, title, content, docType, msg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					A3($author$project$Models$encodeUpdate, title, content, docType)),
				expect: A2($elm$http$Http$expectJson, msg, $author$project$Models$documentDecoder),
				headers: _List_Nil,
				method: 'PUT',
				timeout: $elm$core$Maybe$Nothing,
		...
		switch (msg.$) {
			...
			case 'UpdateNewDocType':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'AddDocument':
				var docType = $elm$core$String$isEmpty(model.newDocument.docType) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(model.newDocument.docType);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loading: true}),
					A5($author$project$Api$addDocument, model.config, model.newDocument.title, model.newDocument.content, docType, $author$project$Main$DocumentAdded));
			case 'DocumentAdded':
				var result = msg.a;
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{
							editingDocument: $elm$core$Maybe$Just(
								A4($author$project$Main$EditingDocument, doc.id, doc.title, doc.content, doc.docType))
						}),
					$elm$core$Platform$Cmd$none);
			...
			case 'DocumentRenamed':
				...
				if (result.$ === 'Ok') {
					var updatedSelectedDoc = function () {
						var _v12 = _Utils_Tuple2(model.selectedDocument, model.editingDocument);
						if ((_v12.a.$ === 'Just') && (_v12.b.$ === 'Just')) {
							var doc = _v12.a.a;
							var editing = _v12.b.a;
...
var $author$project$Main$UpdateNewDocType = function (a) {
	return {$: 'UpdateNewDocType', a: a};
};
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$value(model.newDocument.docType),
										$elm$html$Html$Events$onInput($author$project$Main$UpdateNewDocType),
										$elm$html$Html$Attributes$class('form-input')
									]),
								_List_Nil)
							])),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('AI Search Tool')
					])),
				A2(
				$elm$html$Html$nav,
				_List_Nil,
		...
		_List_fromArray(
			[
				...
				$author$project$Main$SelectDocument(
					{content: result.content, createdAt: result.createdAt, docType: result.docType, id: result.id, index: result.index, title: result.title}))
			]),
		_List_fromArray(
			[
				A2(
				...
				function () {
				var _v0 = result.similarityScore;
				if (_v0.$ === 'Just') {
					var score = _v0.a;
					return A2(
						$elm$html$Html$div,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Total Documents')
										])),
									A2(
									$elm$html$Html$p,
									_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Vector Collections')
										])),
									A2(
									$elm$html$Html$p,
									_List_fromArray(
